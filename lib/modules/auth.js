module.exports = {
    ...
    impersonate: async function(options) {
        ...
        const identity = this.parseOptional(options.identity, 'string', null);
        const username = this.parseOptional(options.username, 'string', null);

        return provider.impersonate(identity, username);
    },
