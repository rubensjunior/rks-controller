...
module.exports = {
    ...
    send: async function(options) {
        ...
        return transport.sendMail({ from, to, cc, bcc, replyTo, subject, html, text, priority, attachments, headers });
    },
